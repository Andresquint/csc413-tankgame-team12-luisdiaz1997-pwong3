...
public class Map extends JFrame
{
    ...
    static private Clip boom;
    static private AudioInputStream wave;
    private static int actions = 0;
       
    	

    public Map(String input) throws UnsupportedAudioFileException, IOException, LineUnavailableException
    {
        super(input);
           ...
           for ( int j = 1 + i ; j < size ; j++)
           {
               ...
               if (distance < minimum)
               {
                   ...
                   else if (a instanceof Bullets)
                   {
                       ...
                       {
                           //System.out.println(arr.size());
////*******explode image and sound here*******************************                           
                           System.out.println("explode");
                           //((Collisions)a).getImage();
